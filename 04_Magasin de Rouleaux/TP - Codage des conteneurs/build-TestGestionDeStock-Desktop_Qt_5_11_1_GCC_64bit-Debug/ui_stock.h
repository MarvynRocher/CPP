...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        lineEditDiametre = new QLineEdit(layoutWidget2);
        lineEditDiametre->setObjectName(QStringLiteral("lineEditDiametre"));

        verticalLayout_3->addWidget(lineEditDiametre);

        lineEditReference = new QLineEdit(layoutWidget2);
        lineEditReference->setObjectName(QStringLiteral("lineEditReference"));

        verticalLayout_3->addWidget(lineEditReference);
